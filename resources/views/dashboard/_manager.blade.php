...
<div class="row">
    <div class="col-lg-6">
        <div class="card-box">
            <h4 class="m-t-0 m-b-30 header-title"><b>Chi phí quảng cáo theo nhân sự</b></h4>
    ...
    <div class="col-lg-6">
        <div class="card-box">
            <h4 class="m-t-0 m-b-30 header-title"><b>Chi phí trên mỗi quảng cáo theo nhân sự</b></h4>
