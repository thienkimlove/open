...
@section('content')
    <div class="row">
        <div class="col-sm-12">
            ...
            <h4 class="page-title">Danh sách Ad Accounts</h4>
            <ol class="breadcrumb">
                <li class="active">
                    Danh sách Ad Accounts
                </li>
            </ol>
        </div>
    </div>
                    ...
                    <div class="col-sm-12">
                        <form class="form-inline" role="form" id="search-form">
                            <div class="form-group m-l-10">
                                <label class="sr-only" for="">Ad Account Name</label>
                                <input type="text" class="form-control" placeholder="Ad Account Name" name="social_name"/>
                            </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box table-responsive">
                <h4 class="m-t-0 header-title"><b>Danh sách ad accounts</b></h4>
