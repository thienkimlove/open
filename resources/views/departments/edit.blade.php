...
@section('content')
    <div class="row">
        <div class="col-sm-12">
            ...
            <h4 class="page-title">Sửa thông tin phòng ban</h4>
            <ol class="breadcrumb">
                <li>
                    <a href="{{ route('departments.index') }}">Phòng ban</a>
                </li>
                <li class="active">
                    Sửa thông tin phòng ban <b># {{$department->name}}</b>
                </li>
            </ol>
        </div>
    </div>
            ...
            <div class="card-box">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        {!! Form::open(['route' => ['departments.update', $department->id], 'method' => 'put', 'role' => 'form', 'class' => 'form-horizontal']) !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                {!! Form::checkbox('status', '1', $department->status, ['data-plugin' => 'switchery', 'data-color' => '#81c868']) !!}
                                <span class="lbl"></span>
                            </div>
                        </div>
